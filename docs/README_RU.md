...
> Мультиплеер НЕ поддерживается. Нельзя приглашать друзей или подключаться к мультиплеерным сессиям через Steam или Paradox Launcher с модифицированной библиотекой.
>
> **🌐 Хотите играть ОНЛАЙН?** Используйте [CreamAPI](https://cs.rin.ru/forum/viewtopic.php?f=29&t=70576) — он поддерживает мультиплеер на всех платформах (Windows, macOS, Linux).
